...
import montoni from '../images/clients/montoni.jpg';
import omiola from '../images/clients/omiola.png';
import obp from '../images/clients/obp.jpg';
                ...
                <div className="p-16" data-aos="fade-in" data-aos-delay="600">
                    <div className="grid sm:grid-cols-3 lg:grid-cols-3">
                        ...
                        <div style={clientImage} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
                            <img src={omiola} alt="client" />                            
                        </div> 

                        <div style={clientImage} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
                            <img src={obp} alt="client" />                            
                        </div>
