        ...
        <>
            <footer>
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    {/* 1st block */}
                    <div className="col-spa-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-4xl mb-4">ByteGuard</h3>
                            <div className='text-md font-medium text-gray-600'>
                                <h5>ByteGuard Technologies</h5>
                                <p>Bodija,</p>
                                <p>Ibadan</p>
                                <p>Oyo State.</p>
                            </div>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        ...
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">QA(VAPT) and Review</Link>
                        </li>
                        <li className="mb-2">
